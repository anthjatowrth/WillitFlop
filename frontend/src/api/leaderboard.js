...
export async function saveToLeaderboard({ verdict, proba, metacritic_score, answers, coverBlob, creator_name = null }) {
  ...
  const entry = {
    ...
    game_mode:       answers.gameMode     || null,
    core_mechanic:   answers.coreMechanic || null,
    visual_style:    answers.visualStyle  || null,
    playtime:        answers.playtime     || null,
    platforms:       answers.platforms?.length > 0 ? answers.platforms : null,
